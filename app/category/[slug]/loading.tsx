  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      <div className="space-y-8">
        <section className="overflow-hidden rounded-[32px] border border-gray-200 bg-white px-6 py-8 shadow-[0_10px_30px_rgba(0,0,0,0.04)] sm:px-8 sm:py-10">
          <div className="space-y-4">
            <div className="h-9 w-28 animate-pulse rounded-full bg-gray-100" />

            <div className="space-y-2">
              <div className="h-10 w-52 animate-pulse rounded-2xl bg-gray-100 sm:h-12 sm:w-72" />
